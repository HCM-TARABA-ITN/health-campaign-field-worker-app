...
class HouseholdSearchModelMapper
  ...
  static String? _$clientCreatedBy(HouseholdSearchModel v) => v.clientCreatedBy;
  static const Field<HouseholdSearchModel, String> _f$clientCreatedBy =
      Field('clientCreatedBy', _$clientCreatedBy, opt: true);
  static int? _$plannedStartDate(HouseholdSearchModel v) => v.plannedStartDate;
  static const Field<HouseholdSearchModel, int> _f$plannedStartDate =
      Field('plannedStartDate', _$plannedStartDate, opt: true);
  static int? _$plannedEndDate(HouseholdSearchModel v) => v.plannedEndDate;
  static const Field<HouseholdSearchModel, int> _f$plannedEndDate =
  ...
  static DateTime? _$plannedStartDateTime(HouseholdSearchModel v) =>
      v.plannedStartDateTime;
  static const Field<HouseholdSearchModel, DateTime> _f$plannedStartDateTime =
      Field('plannedStartDateTime', _$plannedStartDateTime,
          mode: FieldMode.member);
  static DateTime? _$plannedEndDateTime(HouseholdSearchModel v) =>
      v.plannedEndDateTime;
  static const Field<HouseholdSearchModel, DateTime> _f$plannedEndDateTime =
  ...
  final MappableFields<HouseholdSearchModel> fields = const {
    ...
    #clientCreatedBy: _f$clientCreatedBy,
  ...
  static HouseholdSearchModel _instantiate(DecodingData data) {
    return HouseholdSearchModel.ignoreDeleted(
        ...
        clientCreatedBy: data.dec(_f$clientCreatedBy),
...
class _HouseholdSearchModelCopyWithImpl<$R, $Out>
  ...
  HouseholdSearchModel $make(
      ...
      HouseholdSearchModel.ignoreDeleted(
          ...
          isProximityEnabled: data.get(
              #isProximityEnabled,
              or: $value.isProximityEnabled),
          clientReferenceId:
              data.get(#clientReferenceId, or: $value.clientReferenceId),
          tenantId: data.get(#tenantId, or: $value.tenantId),
          householdType: data.get(#householdType, or: $value.householdType),
          clientCreatedBy:
              data.get(#clientCreatedBy, or: $value.clientCreatedBy),
          plannedStartDate:
