...
@RoutePage()
class CustomSurveyFormAcknowledgementPage extends LocalizedStatefulWidget {
  final bool isDataRecordSuccess;
  final String? label;
  final String? description;
  final Map<String, dynamic>? descriptionTableData;
  const CustomSurveyFormAcknowledgementPage({
    super.key,
  ...
  @override
  State<CustomSurveyFormAcknowledgementPage> createState() =>
      CustomAcknowledgementPageState();
}

class CustomAcknowledgementPageState
    extends LocalizedState<CustomSurveyFormAcknowledgementPage> {
  @override
