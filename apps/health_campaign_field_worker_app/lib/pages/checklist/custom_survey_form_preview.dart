...
@RoutePage()
class CustomSurveyFormPreviewPage extends LocalizedStatefulWidget {
  const CustomSurveyFormPreviewPage({
    Key? key,
    super.appLocalizations,
  }) : super(key: key);

  @override
  State<CustomSurveyFormPreviewPage> createState() =>
      CustomSurveyFormPreviewPageState();
}

class CustomSurveyFormPreviewPageState
    extends LocalizedState<CustomSurveyFormPreviewPage> {
  @override
