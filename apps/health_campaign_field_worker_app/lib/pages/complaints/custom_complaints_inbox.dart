...
class CustomComplaintsInboxPage extends LocalizedStatefulWidget {
  const CustomComplaintsInboxPage({
    super.key,
    super.appLocalizations,
  });

  @override
  State<CustomComplaintsInboxPage> createState() =>
      CustomComplaintsInboxPageState();
}

class CustomComplaintsInboxPageState
    extends LocalizedState<CustomComplaintsInboxPage> {
  @override
