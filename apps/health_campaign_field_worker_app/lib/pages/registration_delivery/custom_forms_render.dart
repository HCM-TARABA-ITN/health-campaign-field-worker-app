...
@RoutePage()
class CustomFormsRenderPage extends LocalizedStatefulWidget {
  ...
  @override
  State<CustomFormsRenderPage> createState() => _CustomFormsRenderState();
}

class _CustomFormsRenderState extends LocalizedState<CustomFormsRenderPage> {
  bool _ready = false;
