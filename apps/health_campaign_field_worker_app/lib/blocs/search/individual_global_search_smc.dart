...
import 'search_households_smc.dart';

class IndividualGlobalSearchSMCBloc extends SearchHouseholdsSMCBloc {
  IndividualGlobalSearchSMCBloc(
      ...
      required super.individualGlobalSearchSMCRepository,
      required super.houseHoldGlobalSearchRepository}) {
    on<searchHouseholdsSMC.IndividualGlobalSearchSMCEvent>(
        _individualGlobalSearch);
  }
  ...
  Future<void> _individualGlobalSearch(
    ...
    final results =
        await individualGlobalSearchSMCRepository.individualGlobalSearch(
