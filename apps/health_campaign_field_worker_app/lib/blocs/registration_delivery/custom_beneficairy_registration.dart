...
class CustomBeneficiaryRegistrationBloc
  ...
  FutureOr<void> _handleCreateHousehold(
    BeneficiaryRegistrationCreateHouseholdEvent event,
    BeneficiaryRegistrationEmitter emit,
  ) {
    state.maybeMap(
      orElse: () {
          ...
          await householdRepository.create(
            event.household.copyWith(
              address: address?.copyWith(
                ...
                auditDetails: event.household.auditDetails,
                clientAuditDetails: event.household.clientAuditDetails,
                locality: locality,
              ),
            ),
          );
...
class BeneficiaryRegistrationEvent with _$BeneficiaryRegistrationEvent {
  ...
  const factory BeneficiaryRegistrationEvent.createHousehold({
    required HouseholdModel household,
    required DateTime registrationDate,
